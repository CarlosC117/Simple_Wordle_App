...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var hidden: TextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var click = 0  // Keeps tracks of the clicks done by user
        var numberOfWins = 0  // How many wins you've had
        var added = "Winning Streak: $numberOfWins"
        ...
        guessButton.setOnClickListener {
            ...
            // If checks if word is 4 letters to avoid any errors for inputting less or more
            if (word.length == 4) {
                click++
                ...
                Toast.makeText(this, "This is not 4 letters long", Toast.LENGTH_SHORT).show()
            }

            guessText.text.clear() // This clears out the text field

            if (click == 3) {
                Toast.makeText(this, "No more guesses available!", Toast.LENGTH_SHORT).show()
